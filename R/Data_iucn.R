...
#'@usage data(iucn)
#'@description Result of the function \code{\link{lets.iucn}} applied to Southern American frog genera Phyllomedusa in 2014. 
...
#'@usage data(PAM)
#'@description PresenceAbsence object obtained using the function \code{\link{lets.presab}} in the Geographic distribution of the Southern American frog genera \link{Phyllomedusa}.
...
#'@description Geographic distribution of the Southern American frog genera Phyllomedusa. Data was modfied from IUCN (\url{http://www.iucnredlist.org/}, downloaded in 05/2014). There are 32 species and 46 polygons.
#'@source IUCN - \url{http://www.iucnredlist.org/}. 2014.
